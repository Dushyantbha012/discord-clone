...
function ChatItem({
  ...
  return (
    <div className="relative group flex items-center hover:bg-black/5 p-4 transition w-full">
          ...
          {isPDF && (
            <div className="relative flex items-center p-2 mt-2 rounded-md bg-background/10">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="ml-2 text-sm text-indigo-500 dark:text-indigo-400 gover:underline"
              >
                {fileUrl}
              </a>
            </div>
          ...
          {!fileUrl && !isEditing && (
            <p
              className={cn(
                ...
                deleted &&
                  "italic text-zinc-300 dark:text-zinc-400 text-xs ml-1"
              )}
            >
              {content}
              {isUpdated && !deleted && (
      ...
      {canDeleteMessage && (
        <div className="hidden group-hover:flex items-center gap-x-2 absolute p-1 -top-2 right-5 bg-white dark:bg-zinc-800 border rounedd-md">
          {canEditMessage && (
